  ...
  return (
    <>
      ...
      <div className="px-4">
        ...
        <Service title="Multi – Detox" price="$179" time="(90 mins)">
          Revitalise, clarify, cleanse. The high potency multi-clay mask, with
          kaolin &amp; bentonite, is formulated to promote cell renewal,
          detoxify and calm normal, combination and oily skin types. The blend
          of active ingredients will ensure your skin reclaims a healthy glow.
        </Service>
        <Service title="Age Delay" price="$170" time="(90 mins)">
          ...
          texture and tone. Sonophoresis combined with active ingredients
          ensures deep penetration of products to target the signs of ageing,
          dehydrated skin, photo damage, pigmentation and poor skin texture.
        </Service>
        <Service title="Revitalising" price="$170" time="(90 mins)">
        ...
        <Service title="Ultra Calming" price="$170" time="(90 mins)">
        ...
        <Service title="Bio Hydra" price="$149" time="(45 mins)">
          ...
          facial contains a unique formula of plant extracts and hydraluronic
